            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('contact-us') }}" wire:navigate>Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="contact-form">
                                    <form wire:submit="saveContact">
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none @error('name') is-invalid @enderror" id="contact_name" wire:model.blur="name">
                                            @error('name') <span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="contact_email" class="form-label">Email address</label>
                                            <input type="email" class="form-control shadow-none  @error('email') is-invalid @enderror" id="contact_email" wire:model.blur="email">
                                            @error('email') <span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="contact_mobile" class="form-label">Mobile No</label>
                                            <input type="number" class="form-control shadow-none  @error('mobile') is-invalid @enderror" id="contact_mobile" wire:model.blur="mobile">
                                            @error('mobile') <span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                          <label for="subject" class="form-label">Subject</label>
                                          <input type="text" class="form-control shadow-none @error('subject') is-invalid @enderror" id="subject" wire:model.blur="subject">
                                          @error('subject') <span class="text-danger">{{ $message }}</span>@enderror
                                      </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Write Message</label>
                                            <textarea class="form-control shadow-none" id="message" rows="3" wire:model.blur="message"></textarea>
                                            @error('message') <span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <button class="btn btn-primary w-100" type="submit" wire:loading.disabled>Send Message</button>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        ...
                                        <div class="content">Call Us We Will Be Happy To Help
                                          <br> <a href="tel:{{ $setting?->mobile }}">{{ $setting?->mobile }}</a> 
                                          <br>Monday - Friday
                                    ...
                                    <div class="block mt-4">
                                        ...
                                        <div class="content">{{ $setting?->address }} </div>
                                    </div>
                                    <div class="block">
                                        <ul class="list-unstyled list-inline my-4 social-icons">
                                            <li class="list-inline-item me-3"><a title="Explorer Facebook Profile" class="text-black" href="{{ $setting?->facebook }}"><i class="fab fa-facebook-f"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Twitter Profile" class="text-black" href="{{ $setting?->instagram }}"><i class="fab fa-twitter"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Instagram Profile" class="text-black" href="{{ $setting?->twitter }}"><i class="fab fa-instagram"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
