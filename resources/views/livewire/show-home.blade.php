      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <h1 class="text-capitalize mb-4">{{ $homeSetting?->title }}</h1>
            <p class="mb-4">{{ $homeSetting?->sub_title }} </p>
              @if(!empty($homeSetting?->btn_text) && !empty($homeSetting?->btn_link))
                <a type="button" class="btn btn-primary"
                  href="{{ $homeSetting?->btn_link }}">{{ $homeSetting?->btn_text }}
        ...
        <div class="col-lg-6">
          <div class="ps-lg-5 text-center">
            <img loading="lazy" decoding="async"
              src="{{ url('storage/'.$homeSetting?->image) }}"
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="{{ route('service',[$service]) }}" wire:navigate>
