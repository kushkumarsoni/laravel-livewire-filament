            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('about') }}" wire:navigate>About</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row position-relative">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <div class="card bg-transparent border-0 text-center">
                        <div class="card-img">
                            <img loading="lazy" decoding="async" src="{{ url('storage/'.$member?->image) }}" alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
                            <ul class="card-social list-inline">
                                <li class="list-inline-item"><a class="facebook" href="{{ $member?->fb_url }}" target="_blank"><i class="fab fa-facebook"></i></a>
                                </li>
                                <li class="list-inline-item"><a class="twitter" href="{{ $member?->tw_url }}" target="_blank"><i class="fab fa-twitter"></i></a>
                                </li>
                                <li class="list-inline-item"><a class="instagram" href="{{ $member?->in_url }}" target="_blank"><i class="fab fa-instagram"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
