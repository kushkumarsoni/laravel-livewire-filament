          ...
          <div class="row">
            <div class="col-8 mx-auto text-center">
              ...
              <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                ...
                <li class="list-inline-item">/ &nbsp; <a href="{{ route('page',[$page?->slug]) }}"  wire:navigate>Privacy Policy</a>
                </li>
              </ul>
            </div>
          </div>
...
@else
    <main>
        <div class="text-center"><a href="{{ route('home') }}" class="btn btn-success"  wire:navigate>Go Back</a></div>
    </main>
@endif